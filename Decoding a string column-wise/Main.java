...
class Main{
  public static void main(String args[]) 
  {
    // Type your code here
    	...
    	delete_spaces(str, str_len);	// it will call the delete function and delete all the spaces from the string
    	str_len = str.length();			// it will store the new size of string
  ...
  // it will delete all the spaces of any given string
